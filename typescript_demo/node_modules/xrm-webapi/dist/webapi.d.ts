...
export declare function getHeaders(config: WebApiRequestConfig): any;
/**
 ...
 * @param queryOptions Various query options for the query
 */
export declare function create(apiConfig: WebApiConfig, entitySet: string, entity: Entity, submitRequest: RequestCallback, queryOptions?: QueryOptions): Promise<null>;
/**
 ...
 * @param queryOptions Various query options for the query
 */
export declare function update(apiConfig: WebApiConfig, entitySet: string, id: string, entity: Entity, submitRequest: RequestCallback, queryOptions?: QueryOptions): Promise<null>;
/**
 * Create a record in CRM and return data
 * @param apiConfig WebApiConfig object
 * @param entitySet Type of entity to create
 ...
 * @param queryOptions Various query options for the query
 */
export declare function updateProperty(apiConfig: WebApiConfig, entitySet: string, id: string, attribute: string, value: any, submitRequest: RequestCallback, queryOptions?: QueryOptions): Promise<null>;
/**
 ...
 */
export declare function deleteRecord(apiConfig: WebApiConfig, entitySet: string, id: string, submitRequest: RequestCallback): Promise<null>;
/**
 ...
 */
export declare function deleteProperty(apiConfig: WebApiConfig, entitySet: string, id: string, attribute: string, submitRequest: RequestCallback): Promise<null>;
/**
 ...
 * @param queryOptions Various query options for the query
 */
export declare function associate(apiConfig: WebApiConfig, entitySet: string, id: string, relationship: string, relatedEntitySet: string, relatedEntityId: string, submitRequest: RequestCallback, queryOptions?: QueryOptions): Promise<null>;
/**
 ...
 */
export declare function disassociate(apiConfig: WebApiConfig, entitySet: string, id: string, property: string, submitRequest: RequestCallback, relatedEntityId?: string): Promise<null>;
/**
 ...
 * @param queryOptions Various query options for the query
 */
export declare function boundAction(apiConfig: WebApiConfig, entitySet: string, id: string, actionName: string, submitRequest: RequestCallback, inputs?: object, queryOptions?: QueryOptions): Promise<any>;
/**
 ...
 * @param queryOptions Various query options for the query
 */
export declare function unboundAction(apiConfig: WebApiConfig, actionName: string, submitRequest: RequestCallback, inputs?: object, queryOptions?: QueryOptions): Promise<any>;
/**
 * Execute a default or custom bound action in CRM
 * @param apiConfig WebApiConfig object
 * @param entitySet Type of entity to run the action against
 ...
 * @param queryOptions Various query options for the query
 */
export declare function boundFunction(apiConfig: WebApiConfig, entitySet: string, id: string, functionName: string, submitRequest: RequestCallback, inputs?: FunctionInput[], queryOptions?: QueryOptions): Promise<any>;
/**
 ...
 * @param queryOptions Various query options for the query
 */
export declare function unboundFunction(apiConfig: WebApiConfig, functionName: string, submitRequest: RequestCallback, inputs?: FunctionInput[], queryOptions?: QueryOptions): Promise<any>;
/**
 ...
 * @param queryOptions Various query options for the query
 */
export declare function batchOperation(apiConfig: WebApiConfig, batchId: string, changeSetId: string, changeSets: ChangeSet[], batchGets: string[], submitRequest: RequestCallback, queryOptions?: QueryOptions): Promise<any>;
export {};
